...
# print today's date
now = datetime.now()
print ("today date and time is: " + str(now))


# print today's date one year from now
print ("one year from today will be: " + str(now + timedelta(days=365)))


# create a timedelta that uses more than one argument
print ("in two weeks and 3 days the date and time will be: " + str(now + timedelta(weeks=2, days=3)))
